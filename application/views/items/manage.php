...
<div id="toolbar">
    <div class="pull-left form-inline" role="toolbar">
        ...
        <button id="bulk_edit" class="btn btn-info btn-sm modal-dlg print_hide", data-btn-submit='<?php echo $this->lang->line('common_submit') ?>', data-href='<?php echo site_url($controller_name."/bulk_edit"); ?>'
        ...
        <button id="generate_barcodes" class="btn btn-primary btn-sm print_hide" data-href='<?php echo site_url($controller_name."/generate_barcodes"); ?>' title='<?php echo $this->lang->line('items_generate_barcodes');?>'>
