<div id="receipt_wrapper" style="font-size:<?php echo $this->config->item('receipt_font_size');?>px">
	<div id="receipt_header">
		...
		<div id="sale_receipt"><?php echo $this->lang->line('sales_invoice') ?></div>
		<?php elseif($total <= 0 ):?>		
		<div id="sale_receipt"><?php echo $this->lang->line('sales_return')?></div>
         <?php else:?>		
	...
	<div id="receipt_general_info">
		...
		?>
			...
			<div id="customer"><?php echo $phone_number; ?></div>
			<div id="customer"><?php echo $customer_email; ?></div>				
		<?php
		}
		?>
	...
	<table id="receipt_items">
		...
		?>
			...
			<tr>
				...
				?>
				<?php
				if($this->config->item('receipt_show_description') &&!empty($item['serialnumber']))	
				{
				?>
					<td> <?php echo $this->lang->line("sales_serial"). " : " .$item['serialnumber']; ?></td>
				<?php
				}
				?>
			</tr>
		...
		?>
			...
			?>
				<tr>
					<td colspan="4" class="total-value"><?php echo $sales_tax['tax_group']; ?>:</td>
		...
		?>
		<tr>
			<td colspan="4" style="text-align:right; font-weight: bold; font-size:<?php echo $this->config->item('receipt_font_size')+2 ?>px"><?php echo $this->lang->line('sales_quantity'); ?></td>
			<td style="text-align:right; font-weight: bold; font-size:<?php echo $this->config->item('receipt_font_size')+2 ?>px"><?php echo array_sum(array_column($cart, 'quantity')); ?></td>
		</tr>	
