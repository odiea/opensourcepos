	...
	*/
	public function search($search, $filters, $rows = 0, $limit = 0, $sort = 'cashup_id', $order = 'asc')
	{
		$this->db->select('
			...
			MAX(cash_up.closed_amount_giftcard) AS closed_amount_giftcard,
			MAX(cash_up.closed_amount_check) AS closed_amount_check,
			MAX(cash_up.closed_amount_total) AS closed_amount_total,
			MAX(cash_up.expected_closed_amount_due) AS closed_amount_due,
			...
			MAX(cash_up.expected_closed_amount_giftcard) AS expected_closed_amount_giftcard,
	...
	*/
	public function get_info($cashup_id)
	{
		$this->db->select('
			...
			cash_up.closed_amount_giftcard AS closed_amount_giftcard,
			...
			cash_up.expected_closed_amount_due AS expected_closed_amount_due,
			cash_up.expected_closed_amount_card AS expected_closed_amount_card,
			cash_up.expected_closed_amount_giftcard AS expected_closed_amount_giftcard,
